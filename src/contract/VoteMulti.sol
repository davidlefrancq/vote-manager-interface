...
contract Vote {
	...
	*/
	...
	function getResultsVoteCount(uint _categorie, uint _questionnaire, uint _question) public view returns (uint) {
		require(_categorie < categoriesIndex.length, "categorie not exist!");
		bytes32 id = categoriesIndex[_categorie];
		require(_questionnaire < categories[id].questionnairesIndex.length, "Questionnaire not exist!");
		bytes32 qid = categories[id].questionnairesIndex[_questionnaire];
	...
	function getResultsVoteNbReponses(uint _categorie, uint _questionnaire, uint _question) public view returns (uint) {
		require(_categorie < categoriesIndex.length, "categorie not exist!");
		bytes32 id = categoriesIndex[_categorie];
		require(_questionnaire < categories[id].questionnairesIndex.length, "Questionnaire not exist!");
		bytes32 qid = categories[id].questionnairesIndex[_questionnaire];
		...
		return questions[id].reponses.length;
	}

	function getResultsVote(uint _categorie, uint _questionnaire, uint _question, uint _numReponse) public view returns (uint) {
		require(_categorie < categoriesIndex.length, "categorie not exist!");
		bytes32 id = categoriesIndex[_categorie];
		require(_questionnaire < categories[id].questionnairesIndex.length, "Questionnaire not exist!");
		bytes32 qid = categories[id].questionnairesIndex[_questionnaire];
		...
		return questions[id].counterReponses[_numReponse];
	}
